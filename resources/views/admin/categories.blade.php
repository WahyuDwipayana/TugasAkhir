        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="/dashboard/meja">Categories</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="/dashboard/category/{{$item->id}}" method="POST" onsubmit="return confirm('Hapus Data Menu?')" class="d-inline">
                                        @method('delete')
                                        @csrf
                            ...
                            <div class="modal fade" id="exampleModalLg{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Lihat Data Kategori</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Nama Kategori</label>
                                            <input type="text" name="nama_kategori" class="form-control" value="{{$item->nama_kategori}}" readonly>
                                        </div>
                                    </div>
                            ...
                            <div class="modal fade" id="exampleModalupdate{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        <form action="/dashboard/category/{{$item->id}}" method="post" enctype="multipart/form-data">
                                            @method('put')
                                            @csrf
                                            <div class="form-group">
                                                <input name="nama_kategori"type=text class="form-control @error('nama_kategori') is-invalid @enderror"  value="{{ old('nama_kategori',$item->nama_kategori) }}" id="exampleInputEmail" aria-describedby="emailHelp"  placeholder="Nama Kategori..." autofocus>
                                                @error('nama_kategori')
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="/dashboard/category" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="exampleInputEmail" class="mt-2">Nama Kategori</label>
                                        <input name="nama_kategori"type=text class="form-control @error('nama_kategori') is-invalid @enderror"  value="{{ old('nama_kategori') }}" id="exampleInputEmail" aria-describedby="emailHelp"  placeholder="Nama Kategori..." autofocus>
                                        @error('nama_kategori')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
