                        ...
                        <div class="col-lg-12">
                          <div class="p-5">
                            <div class="text-center">
                              <h1 class="h4 text-gray-900 mb-4">Daftar Akun Admin</h1>
                            </div>

                            <form class="user" action="/registeradmin" method="POST" id="contactDorm">
                                @csrf
                                ...
                                <div style="display: none"><input type="text" value="admin" name="level"></div>
