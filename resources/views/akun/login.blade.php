                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="/login" method="POST" id="contactDorm">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror" value="{{ old('email') }}" id="exampleInputEmail" name="email" aria-describedby="emailHelp" placeholder="Enter Email Address..." autofocus>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <div class="small"><a href="{{ url('register') }}">Tidak punya akun? Buat akun!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
